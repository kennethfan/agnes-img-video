...
**19 views + 3 wizard subdirs** (comic/novel/image). Navigation via `el-tabs` in `App.vue`, not Vue Router.
...
| `ProjectList.vue` | 创作项目 | Project CRUD listing |
| `ProjectEditor.vue` | 项目编辑 | Project detail + AI Recommend + steps |
